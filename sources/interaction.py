...
class Interaction:
    ...
    def emit_status(self):
        """Print the current status of Jarvis+."""
        if self.stt_enabled:
            pretty_print(f"Text-to-speech trigger is {self.ai_name}", color="status")
        if self.tts_enabled:
            self.speech.speak("Hello sir! I’m JarvisPlus, your personal AI assistant. We’re online and ready—how can I help you today?")
        pretty_print("Jarvis+ is ready.", color="status")
